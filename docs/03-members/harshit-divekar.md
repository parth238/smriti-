...
|---------|-----------|------------|--------|
| T0-INF-001 | Scaffold Monorepo Structure | None | NOT_STARTED |
| T1-BE-002 | Database Schema & Alembic | T0-INF-001 | NOT_STARTED |
| T1-BE-003 | JWT Auth APIs | T1-BE-002 | NOT_STARTED |
...
## 22 FIRST TASK
**T0-INF-001:** Scaffold Monorepo Structure.
