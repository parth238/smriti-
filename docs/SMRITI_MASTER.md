...
**Last updated:** 2026-08-31 · Branch `main` · **Final SIH 2026 build — 7/10** · Problem statement: [`docs/SIH-2026-problem-statement.pdf`](SIH-2026-problem-statement.pdf)
...
|-----------|-------|---------|
| **Overall product today** | **7.0 / 10** | Story Mode, Bhashini hook, live Alerts, notifications, 7 games, deploy configs — hosted URL + playtest still on teammates |
| **Judge demo (local seed)** | **7.5 / 10** | Hero loop + `/story` pitch + notifications + live Alerts + Bhashini hook |
...
| 10 | Show §1 scores + `/story` | “7/10 overall; public story at /story; hosted URL pending.” |
